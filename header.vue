				...
				<div class="nav_container">
					...
					<div class="col-sm-4">
						<div id="home_hours_container" class="hidden_phone" v-if="todays_hours">
							<p class="open_now" v-if="todays_hours.open_time ">
							    <span v-if="todays_hours.is_closed == null || !todays_hours.is_closed ">{{$t("header.open_today")}}</span>
        					</p>
        					<p v-else-if="">
    					    	<span v-if="todays_hours.is_closed == null || !todays_hours.is_closed ">{{$t("header.open_now_until")}}</span>
        ...
        return Vue.component("header-component", {
            ...
            data: function() {
                return {
                    ...
                    // property_logo: "//codecloud.cdn.speedyrails.net/sites/5ad8db786e6f64678e960000/image/png/1522945080899/mmlogo500.png",
            ...
            todays_hours () {
                ...
                open_time = moment().tz(this.timezone)
