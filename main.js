...
require(['Vue', 'vuex', 'vue2-filters', 'vue_router', 'routes', 'datastore', 'vue-i18n', 'locales','jquery', 'moment', "vue-meta", "moment-timezone", "vue-moment",'vue-select','vue-simple-spinner','vue!loader.vue', "vue!header.vue", "json!menu_items.json", 'vue!social_links.vue'], function (Vue, Vuex, Vue2Filters, VueRouter, appRoutes, store, VueI18n, messages,$, moment, Meta, tz, VueMoment, VueSelect, Spinner, Loader, Header, MenuItems, SocialLinks) {
    Vue.use(Meta);
    Vue.use(VueRouter);
    Vue.use(Vue2Filters);
    Vue.use(VueI18n);
    ...
    const vm = new Vue({
        ...
        data: function() {
            return {
                ...
                stickyMenu: false,
                isSticky: 700,
                property_logo : "//codecloud.cdn.speedyrails.net/sites/5ad8db786e6f64678e960000/image/png/1524150839429/Logo@2x.png"
            }
        },
        created() {
